<template>
    ...
    >
        <span class="text-lg text-[#33052c] font-bold">Home</span>
    ...
    <Link
        ...
        data-te-sidenav-link-ref
    >
        <span class="text-lg text-[#33052c] font-bold">Categories</span>
    ...
    <Link
        ...
        data-te-sidenav-link-ref
    >
        <span class="text-lg text-[#33052c] font-bold">Sega</span>
        <slot></slot>
    </Link>
</template>
<script setup>
